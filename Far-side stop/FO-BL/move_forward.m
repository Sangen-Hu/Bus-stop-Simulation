function [newbus,newberth,newbus_location,newbuffer_lane_list,newblock_berth_No] = move_forward(bus_No,bus,berth,bus_location,berth_location,buffer_location,buffer_lane_list,run_step,time_step,berth_num,back_headway,block_berth_No,bus_running_list,buffer_num)
