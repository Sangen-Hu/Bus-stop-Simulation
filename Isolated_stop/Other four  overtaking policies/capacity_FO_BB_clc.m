function [bus_stop_capacity,average_delay] = capacity_FO_BB_clc(berth_num_in,service_cs_in,overtaking_in,overtaking_out)
global berth_num;
global back_headway;
...
bus_service_meantime = 25; % unit: second  25~50
