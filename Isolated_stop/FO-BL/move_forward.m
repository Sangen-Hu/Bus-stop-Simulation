function [newbus,newberth,newbus_location,newblock_berth_No] = move_forward(bus_No,bus,berth,bus_location,berth_location,berth_num,block_berth_No,bus_running_list)
	global run_step;
    jam_spacing = 12;
    back_speed = 27 / 3.6;
    moveup_speed = 20 / 3.6;
