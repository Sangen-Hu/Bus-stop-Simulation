function [berth_No,newbus,newberth] = update_target_berth(bus_No,bus,berth,bus_location,bus_lane_list,berth_location,berth_num,lag_delay,block_berth_No,thres_overtaking_in)
